...
const styles = StyleSheet.create({
  ...
  idText: { color: colors.text, fontWeight: "900", letterSpacing: 2, fontSize: 13, marginLeft: 6 },
  photo: {
    width: "100%",
    aspectRatio: 1,
    borderWidth: 2,
  ...
  qrTitle: { fontSize: 14, fontWeight: "900", letterSpacing: 1, color: colors.text, marginBottom: 12 },
