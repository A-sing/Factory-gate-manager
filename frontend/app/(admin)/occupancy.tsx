...
const styles = StyleSheet.create({
  ...
  id: { color: colors.text, backgroundColor: colors.primary, alignSelf: "flex-start", paddingHorizontal: 8, paddingVertical: 2, fontSize: 10, fontWeight: "900", letterSpacing: 1, borderRadius: 2 },
